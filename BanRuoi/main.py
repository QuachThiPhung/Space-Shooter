...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            ...
            end_score = lost_font.render(f"Your Score: {score}", 1, (255,255,255))
            WIN.blit(lost_label, (WIDTH/2 - lost_label.get_width()/ - 50, 350))
            WIN.blit(end_score, (WIDTH/2 - lost_label.get_width()/2, 350))
